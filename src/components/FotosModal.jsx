                ...
                return (
                  ...
                  >
                    ...
                    {puedeBorrar && seleccionadas.size === 0 && (
                      <button onClick={e => { e.stopPropagation(); toggleSeleccion(foto.id) }} style={{ position: 'absolute', top: 4, right: 4, width: 22, height: 22, borderRadius: '50%', background: 'rgba(0,0,0,0.65)', border: 'none', color: '#fff', fontSize: 11, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>✕</button>
                    )}
                  </div>
                )
              })}
